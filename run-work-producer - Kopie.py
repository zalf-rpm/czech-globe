...
PATHS = {
    "hampf": {
        ...
        "LOCAL_ARCHIVE_PATH_TO_PROJECT": "C:/Users/hampf/Documents/GitHub/Europ_Crop_Rot/macsur-croprotations-cz_rerunStepB/", 
        "ARCHIVE_PATH_TO_PROJECT": "C:/Users/hampf/Documents/GitHub/Europ_Crop_Rot/macsur-croprotations-cz_rerunStepB/" ## points to the climate data
    }
}
...
def main():
    ...
    if LOCAL_RUN:
        ...
        socket.connect("tcp://cluster1:" + str(config["port"]))
    ...
    with open(base_path + "/macsur-croprotations-cz_rerunStepB/step_B/soils/good_soil.json") as _:
        sites["good_soil"] = json.load(_)
    with open(base_path + "/macsur-croprotations-cz_rerunStepB/step_B/soils/poor_soil.json") as _:
    ...
    soils = ["universal", "lednice", "milhostov", "mueh", "muen", "oedum", "ukkel"]
    ...
    def generate_and_send_env(station, soil_type, rot_id, climate, rcp, realization, counter):
        ...
        if LOCAL_RUN:
            env["pathToClimateCSV"] = PATHS[USER]["LOCAL_ARCHIVE_PATH_TO_PROJECT"] + "converted/no_snow_cover_assumed/" + weather_file_name
        else:
            env["pathToClimateCSV"] = PATHS[USER]["ARCHIVE_PATH_TO_PROJECT"] + "converted/no_snow_cover_assumed/" + weather_file_name ## currently its the same folder...
                ...
                for climate in climate_data:
                    for rcp in rcps:
                         for realization in range(1, 21):
                            #if station == "BEUKKL" and soil == "ukkel" and climate == "GFDL-CM3"  and rcp== "RCP26" and rotation_id == "05" and realization == 1:
                            # if station == "BEUKKL" and soil != "universal" and station == "VER" and rotation_id == "05" and realization == 1:
